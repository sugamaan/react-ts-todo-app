  ...
  return (
    <>
      <select
        defaultValue="all"
        onChange={(e) => {
          handleSelect(e.target.value as Filter);
        }}
      >
          ...
          return (
            <li key={todo.id}>
              <input
                ...
                onChange={() => {
                  handleCheckbox(!todo.checked, todo.id);
                }}
              />
              <input
                type="text"
                ...
                onChange={(e) => handleFormInput(e.target.value, todo.id)}
              />
              <button
                onClick={() => {
              ...
              <button
                onClick={() => {
                  handleRemoved(!todo.removed, todo.id);
                }}
              >
                削除フラグ追加
              </button>
